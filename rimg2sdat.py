...
parser.add_argument('-o', dest='outdir', metavar='outdir', default=".", help='output directory, default: current directory')
parser.add_argument('-p', dest='prefix', metavar='prefix', default="system", help='name of sparse data image (prefix.new.dat), default: system')
parser.add_argument('-v', dest='version', metavar='version', default=4, type=int, choices=range(1,5), help='transfer list version number, default: 4')
parser.add_argument('-c', dest='compress', action='store_true', default=False, help='compress the new.dat file to new.dat.br file with brotli. (WARNING! Only Android 8.1 support)')
parser.add_argument('-nl', dest='nolimit', action='store_true', default=False, help='when version was 4, no limit 1024 blocks in single command')
parser.add_argument('-sha1', dest='sha1', action='store_true', default=False, help='get sha1 checksums of sparse data image')
